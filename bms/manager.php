            	...
            	<form method="get" action="search.php">
                    ...
                    <div>
						<?
                            ...
                            $result=mysql_query("select * from bms_article where aauthor='$author'",$conn);
                        ?>
                        <table border="1" width="95%"  align="center">
                            <tr bgcolor="#e0e0e0" >
                                <th width="220px">标题</th><th>内容</th><th width="160px">上传时间</th><th>删除</th><th>修改</th>
                            </tr>
                            ...
                            <td><?=$content?></td>
                            <td><?=$row['adate'] ?></td>
                            <td><a href="delete.php?id=<?=$row['id']?>" onClick="return confirm('确认要删除吗？')">删除</a></td>
